...
const Home = () => {
    ...
    <>
        ...
        <div className="pt-28 px-2 dark:bg-[#180B37] bg-slate-300 h-screen absolute top-0 z-[-1]">
            <Link to='/home/nomoz_vaqtlari' className="relative dark:border dark:p-3 border-white"> 
                <h2 className="absolute bebas text-white text-[33px] bottom-12 left-3 font-semibold">Nomoz vaqtlari</h2>
